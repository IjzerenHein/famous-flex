...
* [class: LayoutController ⏏](#exp_module_LayoutController)
  ...
  * [layoutController.get(indexOrId)](#module_LayoutController#get)
  * [layoutController.swap(index, index2)](#module_LayoutController#swap)
  * [layoutController.replace(indexOrId, renderable)](#module_LayoutController#replace)
...
**Returns**: `LayoutController` - this  
<a name="module_LayoutController#get"></a>
###layoutController.get(indexOrId)
...
**Returns**: `LayoutController` - this  
<a name="module_LayoutController#replace"></a>
###layoutController.replace(indexOrId, renderable)
Swaps two renderables at the given positions.
...
**Returns**: `Renderable` - replaced renderable  
